...
<html>
	...
	<script type="text/javascript">
		$(function(){
		var dg = parent.$("iframe[title='课程管理']").get(0).contentWindow.$("#dg");
	...
	<body>
		<form title="更新商品" id="ff" method="post" >
			<div>
				<label for="did">课程编号：</label>
				<input type="text" name="cid" id="cid" disabled="disabled"/>
			</div>
			<div>
